...
public class RedEyeball extends MoveEntity {
    public RedEyeball(
            final String ID,
            Point position,
    ...
    {
        Optional<Entity> redEyeTarget =
                world.findNearest(position, Eyeball.class);
        world.findNearest(position, Eyeball.class);
        long nextPeriod = ACTIONPERIOD;

        if (redEyeTarget.isPresent()) {
            Point tgtPos = redEyeTarget.get().getPosition();
            if (move(world, redEyeTarget.get(), scheduler)) {
...
//import java.util.List;
//
//public class RedEyeball extends Entity {
//
//    public RedEyeball(
//            final String ID,
//            Point position,
